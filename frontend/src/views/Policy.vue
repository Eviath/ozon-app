<template>
  <div class="privacy-policy">
    ...
    <hr />
    <p>
      <strong>2. Źródło</strong>
      <br />Ten dokument został utworzony przy użyciu szablonu firmy SEQ Legal (seqlegal.com)
    </p>
    <p>
      <strong>3. Zbieranie danych osobowych</strong>
    </p>
    ...
    <ol>
      ...
      <li>informacje wprowadzane podczas tworzenia profilu w naszej witrynie &mdash; na przykład imię i nazwisko, zdjęcia profilowe, płeć, data urodzin, status związku, zainteresowania i hobby, dane edukacyjne i dane dotyczące zatrudnienia;</li>
    ...
    <p>
      <strong>4. Korzystanie z Twoich danych osobowych</strong>
    </p>
    ...
    <p>
      <strong>5. Ujawnianie danych osobowych</strong>
    </p>
    <p>Możemy ujawniać dane osobowe użytkownika wszelkim naszym pracownikom, członkom kadry kierowniczej, przedstawicielom, dostawcom lub podwykonawcom, o ile jest to niezbędne do celów określonych w niniejszych &bdquo;Zasadach ochrony prywatności&rdquo;.</p>
    <p>Możemy ujawniać dane osobowe wszelkim członkom naszej grupy spółek (tzn. spółkom zależnym, głównej spółce holdingowej i jej spółkom zależnym), o ile jest to niezbędne do celów określonych w niniejszych &bdquo;Zasadach ochrony prywatności&rdquo;.</p>
    ...
    <p>Z wyjątkiem postanowień zawartych w niniejszych &bdquo;Zasadach ochrony prywatności&rdquo; nie będziemy udostępniać osobom trzecim informacji dotyczących użytkownika.</p>
    <p>
      <strong>6. Międzynarodowe transfery danych</strong>
    </p>
    <ol>
      <li>Informacje, które gromadzimy mogą być przechowywane i przetwarzane w każdym z krajów, w którym prowadzimy działalność i mogą być przesyłane pomiędzy tymi krajami w celu umożliwienia wykorzystania informacji zgodnie z niniejszymi &bdquo;Zasadami ochrony prywatności&rdquo;.</li>
    ...
    <p>
      <strong>7. Zachowywanie danych osobowych</strong>
    </p>
    <ol>
    ...
    <p>
      <strong>8. Bezpieczeństwo danych osobowych</strong>
    </p>
    <ol>
    ...
    <p>
      <strong>11. Strony Internetowe osób trzecich</strong>
    </p>
    ...
    <p>
      <strong>12. Aktualizacja informacji</strong>
    </p>
    ...
    <p>
      <strong>13. Działanie zgodnie z prawem</strong>
    </p>
    <p>Serwis ozonexpert.pl zapewnia każdemu Klientowi całkowitą anonimowość i dyskrecję. Materiały edukacyjne, które zostały przez nas przygotowane mogą być wykorzystane jesynie w sposób, który nie narusza przepisów Prawa Autorskiego oraz Art. 272 Kodeksu Karnego. Pomoc, którą oferujemy ma na celu przyspieszenie procesu nauki i jest w pełni zgodna z polskim prawem. Serwis nie ponosi odpowiedzialności za dalsze użytkowanie i sposób ich wykorzystania. Zapraszamy do zapoznania się z polityką firmy.</p>
  </div>
</template>
